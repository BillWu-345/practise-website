...
class SandwichesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sandwich" do
    assert_difference("Sandwich.count") do
      post sandwiches_url, params: { sandwich: { bread: @sandwich.bread, cheese: @sandwich.cheese, meat: @sandwich.meat } }
    end
  ...
  test "should update sandwich" do
    patch sandwich_url(@sandwich), params: { sandwich: { bread: @sandwich.bread, cheese: @sandwich.cheese, meat: @sandwich.meat } }
